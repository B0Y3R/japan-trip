...
window.TRIP = {
  ...
  cities: [
    // ===================================================== TOKYO
    {
      ...
      days: [
        { date: "Fri 11/20", area: "Arrival · Haneda 4:40p", note: "Clear immigration with the Visit Japan Web QR, grab a Suica + cash. First-night ritual: a konbini run on the way home.", cards: [
          { kind: "eat", name: "Coco Ichibanya", blurb: "Warm customizable curry, open late, zero decision fatigue after 20h of travel.", query: "Coco Ichibanya Tokyo" },
        ] },
        { date: "Sat 11/21", area: "Yoyogi · Harajuku · Shibuya", cards: [
          { kind: "sight", name: "Meiji Jingu", blurb: "Start early — the forest approach is a calm reset before Harajuku. Free.", query: "Meiji Jingu Tokyo" },
          ...
          { kind: "eat", name: "d47 Shokudo", blurb: "Regional teishoku from all 47 prefectures, big windows over the Shibuya tracks.", tags: ["dinner"], query: "d47 Shokudo Shibuya Hikarie" },
          { kind: "bar", name: "The SG Club", blurb: "Shingo Gokan's World's-50-Best bar — banana old-fashioned. Reserve. Closed Mon.", tags: ["★ bar"], url: "https://sg-management.jp/" },
        ] },
        { date: "Sun 11/22", area: "Shimokitazawa · Sangenjaya", cards: [
          ...
          { kind: "bar", name: "LIVE HAUS", blurb: "Catch a show, then graze the natural-wine and tiny bars on the south side.", tags: ["live"], query: "LIVE HAUS Shimokitazawa" },
        ] },
        { date: "Mon 11/23", area: "Shinjuku · Nakano", cards: [
          { kind: "shop", name: "Nakano Broadway", blurb: "Vintage watches, Mandarake floors, and famous steamed dumplings at the east entrance.", query: "Nakano Broadway" },
          { kind: "eat", name: "Omoide Yokocho", blurb: "Smoky lantern-lit yakitori alley by Shinjuku station. Bounce between counters.", tags: ["dinner"], query: "Omoide Yokocho Shinjuku" },
          { kind: "bar", name: "Shinjuku Golden Gai", blurb: "200+ tiny themed bars in six alleys, small covers. Pick a welcoming door. (SG & Benfiddich closed Mon.)", tags: ["★ bars"], query: "Shinjuku Golden Gai" },
        ] },
        { date: "Tue 11/24", area: "Nakameguro · Ebisu", cards: [
          { kind: "coffee", name: "Onibus Coffee Nakameguro", blurb: "Canal-side third-wave coffee by the Meguro River. Perfect mid-morning.", query: "Onibus Coffee Nakameguro" },
          { kind: "eat", name: "Shodai (white curry udon)", blurb: "Silky potato-foam curry udon, minimalist room, rarely a wait.", tags: ["dinner"], query: "Shodai white curry udon Ebisu" },
          { kind: "bar", name: "Bar Trench (Ebisu)", blurb: "Dark, intimate, one of Tokyo's best cocktail dens. Or Bar Martha for vinyl + whisky.", tags: ["cocktails"], query: "Bar Trench Ebisu" },
        ] },
        { bridge: { to: "kyoto", text: "Wed 11/25 – Fri 11/27 · Kyoto leg →" } },
        { date: "Fri 11/27", area: "Back to Tokyo", note: "Easy re-entry — drop bags, low-key Shimokita or Shibuya evening.", cards: [
          { kind: "bar", name: "Bar Benfiddich", blurb: "Open Fri — farm-to-glass alchemy, top-20 in the world. Reserve via their Instagram drop.", tags: ["★ bar"], query: "Bar Benfiddich Shinjuku" },
        ] },
        { date: "Sat 11/28", area: "Kichijoji · Koganei", cards: [
          { kind: "sight", name: "Edo-Tokyo Open Air Architectural Museum", blurb: "Relocated historic buildings — the one that inspired Spirited Away's bathhouse street.", tags: ["~¥400"], url: "https://www.tatemonoen.jp/english/" },
          { kind: "eat", name: "Satou (Kichijoji)", blurb: "Legendary Wagyu menchi-katsu from the takeaway window. Then wander Harmonica Yokocho.", tags: ["lunch"], query: "Satou Kichijoji" },
        ...
        { date: "Sun 11/29", area: "Asakusa · Ueno · Yanesen", cards: [
          ...
          { kind: "eat", name: "Asakusa Imahan", blurb: "Historic sukiyaki/shabu-shabu, a proper old-Tokyo sit-down.", tags: ["lunch"], query: "Asakusa Imahan" },
          ...
          { kind: "sight", name: "Yanaka Ginza", blurb: "Old shotengai for menchi-katsu and a glimpse of pre-war Tokyo. Great late-afternoon.", query: "Yanaka Ginza" },
        ] },
        { bridge: { to: "hakone", text: "Mon 11/30 · Hakone onsen night →" } },
        { date: "Tue 12/1", area: "Akihabara · Kagurazaka", cards: [
          { kind: "sight", name: "Akihabara", blurb: "Electronics, retro games, gachapon. Kanda Matsuya nearby for historic hand-cut soba.", query: "Akihabara Tokyo" },
          { kind: "sight", name: "Kagurazaka", blurb: "Cobblestone 'little Paris' — hidden lanes, teahouses, French bistros. Le Bretagne for galettes.", query: "Kagurazaka Tokyo" },
          { kind: "bar", name: "Bar Benfiddich", blurb: "Open Tue — Hiroyasu Kayama grinds herbs at the bar. The perfect Benfiddich night. Reserve.", tags: ["★ bar"], query: "Bar Benfiddich Shinjuku" },
        ] },
        ...
        { date: "Thu 12/3", area: "Ginza · Nihonbashi", cards: [
          { kind: "eat", name: "Tsujihan (Nihonbashi)", blurb: "Legendary kaisendon — seafood over rice, finished with sea-bream dashi. Queue 45–60 min, cheap.", tags: ["★ lunch"], query: "Tsujihan Nihonbashi" },
          ...
          { kind: "eat", name: "Ginza dinner", blurb: "Splurge on Bird Land (Michelin yakitori) or keep it simple with Kagari ramen; or the Mitsukoshi depachika.", tags: ["dinner"], query: "Kagari ramen Ginza" },
          { kind: "bar", name: "Bar High Five (Ginza)", blurb: "Hidetsugu Ueno's no-menu temple of the classic cocktail. Closed Wed/Sun → Thu works.", tags: ["★ bar"], query: "Bar High Five Ginza" },
        ] },
        { date: "Fri 12/4", area: "Departure · Narita ~3p", note: "Last konbini haul + depachika souvenirs. You land Haneda but LEAVE from Narita — allow 90+ min (N'EX ~80 min). Moving by ~2:30–3p for the 6:15p to Vancouver.", cards: [] },
      ],
      sections: [
    ...
    // ===================================================== KYOTO
    {
      ...
      days: [
        { date: "Wed 11/25", area: "Arrive · Nishiki · Pontocho · Gion", note: "Early Shinkansen out (book Oct 25), drop bags, ease in.", cards: [
        ...
        { date: "Thu 11/26", area: "E-bike · Higashiyama · Kamo sunset", cards: [
          { kind: "activity", name: "Kyoto e-bike tour", blurb: "Great for the spread-out sights — many run through Arashiyama (bamboo grove) or a temple loop. Book ahead.", tags: ["~¥10,000"], query: "Kyoto ebike tour" },
